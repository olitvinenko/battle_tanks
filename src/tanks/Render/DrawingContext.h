...
public:
	...
	void DrawSprite(size_t tex, unsigned int frame, SpriteColor color, float x, float y, Vector2 dir);
	void DrawSprite(size_t tex, unsigned int frame, SpriteColor color, float x, float y, float width, float height, Vector2 dir);
