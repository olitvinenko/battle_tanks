...
private:
	...
	void SetViewport(const math::RectInt *rect) override;
	void SetScissor(const math::RectInt *rect) override;
	void Camera(const math::RectInt *vp, float x, float y, float scale) override;
	...
	bool TexCreate(Texture &tex, const Image &img) override;
	void TexFree(Texture tex) override;

	MyVertex* DrawQuad(Texture tex) override;
...
void RenderOpenGL::SetScissor(const math::RectInt *rect)
{
	Flush();
	if (rect)
	{
...
void RenderOpenGL::SetViewport(const math::RectInt *rect)
{
	Flush();
...
void RenderOpenGL::Camera(const math::RectInt *vp, float x, float y, float scale)
{
	SetViewport(vp);
	SetScissor(vp);
...
bool RenderOpenGL::TexCreate(Texture &tex, const Image &img)
{
...
void RenderOpenGL::TexFree(Texture tex)
{
...
MyVertex* RenderOpenGL::DrawQuad(Texture tex)
{
