...
//	_gameViews.AddView<GC_Bullet>(Make<Z_Const>(Z_PROJECTILE), Make<R_Sprite>(tm, "projectile_bullet"));
	...
	_gameViews.AddView<GC_Wood>(Make<Z_Const>(Z_WOOD), Make<R_Tile>(tm, "wood", 0xffffffff, Vector2{ 0, 0 }));
	_gameViews.AddView<GC_Wood>(Make<Z_Const>(Z_SHADOW), Make<R_Tile>(tm, "wood_shadow", 0x50000000, Vector2{ 8, 8 }));
	_gameViews.AddView<GC_Water>(Make<Z_Const>(Z_WATER), Make<R_Tile>(tm, "water", 0xffffffff, Vector2{ 0, 0 }));
