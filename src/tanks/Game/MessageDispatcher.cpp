...
//------------------------------------------------------------------------
void MessageDispatcher::Discharge(GameEntityBase* pReceiver, const Telegram& telegram)
{
                                    ...
                                    void*        AdditionalInfo = NULL)
{
  ...
  //get a pointer to the receiver
	GameEntityBase* pReceiver = EntityMgr->GetEntityFromID(receiver);
...
{ 
         ...
         (PriorityQ.begin()->DispatchTime > 0) )
  {
    ...
    //find the recipient
	GameEntityBase* pReceiver = EntityMgr->GetEntityFromID(telegram.Receiver);
