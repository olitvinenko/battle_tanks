...
private:
  ...
  typedef std::map<int, GameEntityBase*> EntityMap;
...
public:
  ...
  void            RegisterEntity(GameEntityBase* NewEntity);

  //returns a pointer to the entity with the ID given as a parameter
  GameEntityBase* GetEntityFromID(int id)const;

  //this method removes the entity from the list
  void            RemoveEntity(GameEntityBase* pEntity);
